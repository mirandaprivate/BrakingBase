...
#[derive(Clone, Debug)]
pub struct SdigSpec<An, Ad, Bn, Bd, Rn, Rd, C, D, Blen>
where
    ...
    C: Unsigned + Debug + Sync,
    D: Unsigned + Debug + Sync,
    Blen: Unsigned + Debug + Sync,
{
    _p: PhantomData<(An, Ad, Bn, Bd, Rn, Rd, C, D, Blen)>,
}

impl<An, Ad, Bn, Bd, Rn, Rd, C, D, Blen> SdigSpecification for SdigSpec<An, Ad, Bn, Bd, Rn, Rd, C, D, Blen>
where
    An: Unsigned + Debug + Sync,
    Ad: Unsigned + Debug + Sync,
    Bn: Unsigned + Debug + Sync,
...
/// Improved codes from the paper by Habock.
/// line 1 from table
