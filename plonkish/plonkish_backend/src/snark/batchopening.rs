...
// pub fn batch_opening<F: PrimeField>(
//     evaluations: Vec<F>,
...
//         .fold(F::ZERO, |acc, (eq_val, basis_val)| {
...
//     let mut w_init_evaluations = vec![F::ZERO; 6];
//     let mut s_evaluations = vec![F::ZERO; 6];
//     let mut r_evaluations = vec![F::ZERO; 6];
//     let mut w_update_evaluations = vec![F::ZERO; 6];
...
//         w_update_evaluations[c] = r_evaluations[c] + F::ONE;
...
//         w_update_evaluations[c + 3] = r_evaluations[c + 3] + F::ONE;
//     }
...
// pub fn batch_spartan_sum_check_verification<F: PrimeField>(
//     evaluation: F,
...
// //     pub e_rx_evals: Vec<F>,
// //     pub e_ry_evals: Vec<F>,
// //     pub val_evals: Vec<F>,
// // }

// // impl BatchSumCheckEvals {
// //     pub fn new(e_rx_evals: Vec<F>, e_ry_evals: Vec<F>, val_evals: Vec<F>) -> BatchSumCheckEvals {
// //         BatchSumCheckEvals {
// //             e_rx_evals,
// //             e_ry_evals,
// //             val_evals,
...
// fn evaluate_indicies<F: PrimeField>(random_values: &Vec<F>) -> F {
//     let mut evaluation = F::ZERO;
//     let bits = random_values.len() - 1;
//     for i in 0..random_values.len() {
//         evaluation += F::from(1u64 << (bits - i)) * random_values[i];
//     }
//     evaluation
// }
